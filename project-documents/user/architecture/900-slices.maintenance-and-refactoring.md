...
**Status:** not started · **Risk:** Low (Part C) / Medium (Parts A/B) · **Effort:** 2/5 · **Dependencies:** [910 (Part A defines what an iteration produces and feeds back), 909 (Part A's artifact post-condition is the hook Part B stamps from)]
