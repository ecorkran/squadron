...
- Whether a minor template revision inherits prior calibration or forces full re-calibration — churn must not perpetually reset n and starve graduation (322, slice-design).
