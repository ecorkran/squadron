...
- [ ] **T1. Create branch and skeleton files**
...
- [ ] **T2. Define `CheckStatus` and `CheckResult` in `doctor_checks.py`**
...
- [ ] **T3. Add unit tests for `CheckResult` and `CheckStatus`**
...
- [ ] **T4. Implement `check_squadron_install()`**
  - In `doctor_checks.py`.
...
- [ ] **T5. Test `check_squadron_install()`**
...
- [ ] **T6. Implement `check_slash_commands(target: Path | None = None)`**
...
- [ ] **T8. Implement `check_provider_profiles()`**
...
- [ ] **T9. Test `check_provider_profiles()`**
...
- [ ] **T10. Implement `check_at_least_one_provider(profile_results: list[CheckResult])`**
...
- [ ] **T17. Test `check_claude_code_session()`**
...
- [ ] **T18. Implement `check_providers_toml()`**
...
- [ ] **T20. Implement `check_models_toml()`**
...
- [ ] **T21. Test `check_models_toml()`**
  - Mirror of T19 over `models_toml_path`.

- [ ] **T22. Implement `check_project_env()`**
...
- [ ] **T24. Implement `run_all_checks()` aggregator in `doctor_checks.py`**
...
- [ ] **T26. Implement Rich rendering in `doctor.py`**
...
- [ ] **T27. Implement JSON rendering in `doctor.py`**
...
- [ ] **T28. Implement `doctor()` Typer command in `doctor.py`**
...
- [ ] **T29. Register command in `cli/app.py`**
...
- [ ] **T30. Integration test via Typer `CliRunner`**
...
- [ ] **T32. Manual verification — slice scenarios**
