...
- [ ] **T9. Add path-existence check (all template types)**
  - File: same as T8.
...
- [ ] **T10. Add tests for diff-membership and path-existence warnings**
...
- [ ] **T11. Manual end-to-end verification (code template)**
...
- [ ] **T12. Manual end-to-end verification (arch template)**
...
- [ ] **T13. Documentation and final commits**
