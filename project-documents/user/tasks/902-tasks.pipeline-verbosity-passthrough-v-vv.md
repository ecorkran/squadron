...
- [ ] **T1. Add `verbosity` parameter to `_render_review`**
...
- [ ] **T2. Update test: existing `_render_review` assertion**
...
- [ ] **T3. Add parametrized verbosity tests for `_render_review`**
  - File: `tests/pipeline/test_prompt_renderer.py`
...
- [ ] **T4. Forward `verbosity` through `_build_action_instruction`**
  - File: `src/squadron/pipeline/prompt_renderer.py`
...
- [ ] **T5. Add `verbosity` parameter to `render_step_instructions`**
  - File: `src/squadron/pipeline/prompt_renderer.py`
...
- [ ] **T6. Thread `verbose` into `_handle_prompt_only_init`**
...
- [ ] **T7. Thread `verbose` into `_handle_prompt_only_next`**
  - File: `src/squadron/cli/commands/run.py`
...
- [ ] **T8. Commit: prompt_renderer + run.py changes**
...
- [ ] **T9. Update `/sq:run` slash command — input parsing section**
...
- [ ] **T10. Update `/sq:run` slash command — Step 0 command template**
  - File: `commands/sq/run.md`
...
- [ ] **T11. Commit: slash command update**
